...
Protecting vulnerable road users is a very important task as in roughly 50 \% of all accidents vulnerable road users are involved. Vulnerable road users are pedestrians or drivers of two-wheeled vehicles.

A technology is needed that warns both the vulnerable road user and the car driver if an accident between them is likely to happen.  This is not an easy challenge because the warnings have to be sent in time  and also it has to ensured that not people are warned who are not really affected by the approaching car.
